...
public class UsuRutasActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{

    RecyclerView recyclerView;
    ListaRutasAdapter adapter;
    ArrayList<Ruta> listPrestados;
    //LAYOUT
    Button rolToolbar;
    ...
    Intents inte = new Intents(UsuRutasActivity.this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_usu_rutas);
        ...
        btnMas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                popupMenu = new PopupMenu(UsuRutasActivity.this, view);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.salir:
                                ...
                                break;
                            default:
                                return UsuRutasActivity.super.onOptionsItemSelected(menuItem);
                        }
                        return true;
                    }
                });
    ...
    private void lista()
    {
        ...
        call.enqueue(new Callback<List<Ruta>>() {
            ...
            public void onResponse(Call<List<Ruta>> call, Response<List<Ruta>> response) {
                ...
                adapter = new ListaRutasAdapter((ArrayList<Ruta>) user, UsuRutasActivity.this, actualizar, ventana);
