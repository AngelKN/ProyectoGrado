...
public class AdminUsuariosActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    Intents inte = new Intents(AdminUsuariosActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                popupMenu = new PopupMenu(AdminUsuariosActivity.this, view);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.agregar:
                                ...
                                break;
                            case R.id.salir:
                                AlertDialog.Builder alerta = new AlertDialog.Builder(AdminUsuariosActivity.this);
                                ...
                                break;
                            default:
                                return AdminUsuariosActivity.super.onOptionsItemSelected(menuItem);
                        }
                        return true;
                    }
                });
    ...
    private void lista()
    {
        ...
        Call<List<Usuario>> call = interfaces.findAll();
        call.enqueue(new Callback<List<Usuario>>() {
            ...
            public void onResponse(Call<List<Usuario>> call, Response<List<Usuario>> response) {
                ...
                adapter = new ListaUsuariosAdapter((ArrayList<Usuario>) user, AdminUsuariosActivity.this, actualizar, ventana);
    ...
    private void verLibrosDisponibles() {
        Intent intent3 = new Intent(this, AdminUsuariosActivity.class);
